...
| [Modal](./modal) | Modal overlay legado inline (confirmação, destrutivo, alerta, info, formulário, lista) | 132 |
| [Modal Radix](./modal-radix) | Composite sobre Dialog Radix — ChangelogModal, ModalFooter, X padrão DS | 125 |
