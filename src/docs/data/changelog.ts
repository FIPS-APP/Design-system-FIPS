...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    entries: [
      ...
      { type: 'improvement', description: 'Página Stacks (`/docs/stacks`): card de gráficos trocado de Recharts para Apache ECharts (descrição, destaques e link oficial), refletindo a decisão de migrar a lib de data viz dos dashboards FIPS. Migração de código ainda pendente (`DashboardDemo.tsx` ainda usa `recharts`).' },
