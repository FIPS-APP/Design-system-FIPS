...
const progressExportCode = `// DS-FIPS — Progress — Copy-paste ready
import { useState, useEffect } from "react";
...
export default function ProgressDoc() {
  ...
  return (
    ...
    <div style={{ minHeight: "100vh", background: "var(--color-surface-muted)", fontFamily: F.body, color: C.cinzaEscuro }}>
      ...
      {/* HEADER */}
      <header style={{ background: `linear-gradient(135deg,var(--color-gov-gradient-from) 0%,var(--color-gov-gradient-to) 100%)`, padding: mob ? "32px 20px 30px" : xl ? "56px 56px 52px" : "48px 40px 44px", position: "relative", overflow: "hidden" }}>
