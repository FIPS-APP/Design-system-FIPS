...
const MENU: MenuItem[] = [
  ...
  { icon: ShieldCheck, label: 'Governança', href: '/docs/governance' },
  {
    ...
    children: [
      ...
      { icon: SlidersHorizontal, label: 'Filtro', href: '/docs/patterns/filtro' },
...
function SidebarDarkPlayground({ mob }: { mob: boolean }) {
  ...
  return (
    <Section
      ...
      desc="Mesma sidebar com tema escuro: fundo #1A1A1A, tiles neumórficos adaptados, accent laranja mantido."
    >
      <Card mob={mob}>
